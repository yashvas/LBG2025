...
export default function SavingsPage() {
  ...
  return (
    <div>
      <h1>Savings Page</h1>
      <p>
        Welcome to the savings page. Here you can manage your savings accounts.
      </p>
      <h2>Savings Tracker</h2>
      <ToDoList objectives={objectives} setObjectives={setObjectives} />
      ...
      {monthsNeeded !== null && (
        <>
          <p>
            Time to reach your savings goal: <strong>{monthsNeeded}</strong>{" "}
            months
          </p>
        </>
      )}
